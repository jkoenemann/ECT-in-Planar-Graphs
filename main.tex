...
%\begin{remark}
% analysis on how to improve 11apx %
...
\begin{center}
 ...
 \includegraphics[width=0.45\textwidth]{b-face.pdf}    \subcaption{Here $w''=w$. Since $w,u$ are consecutive in $G$, $u''$ must lie before $w'$.} \label{bface}
\end{subfigure} %\hspace{-0.23\textwidth}
     \begin{subfigure}[t]{0.45\textwidth}
     ...
     \end{subfigure} %\hspace{-0.7\textwidth}
     \caption{} \label{}
        \end{center}
\end{figure}
